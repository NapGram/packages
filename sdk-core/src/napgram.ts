...
export interface QQClientAPI {
    ...
    nickname?: string;
    clientType?: string;
    sendGroupPoke?(groupId: string, userId: string): Promise<void>;
    sendLike?(userId: string, times: number): Promise<void>;
    getGroupHonorInfo?(groupId: string, type?: string): Promise<any>;
    getGroupMemberInfo?(groupId: string, userId: string): Promise<any>;
    banUser?(groupId: string, userId: string, duration: number): Promise<any>;
    unbanUser?(groupId: string, userId: string): Promise<any>;
    kickUser?(groupId: string, userId: string, rejectAddRequest?: boolean): Promise<any>;
    setGroupCard?(groupId: string, userId: string, card: string): Promise<any>;
    setGroupWholeBan?(groupId: string, enable: boolean): Promise<any>;
    setGroupAdmin?(groupId: string, userId: string, enable: boolean): Promise<any>;
    setGroupName?(groupId: string, name: string): Promise<any>;
    setGroupSpecialTitle?(groupId: string, userId: string, title: string, duration?: number): Promise<any>;
